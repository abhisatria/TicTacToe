package com.example.abhiw.tictactoe;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(player1Turn)
        {
            textViewPlayer1.setTextColor(Color.parseColor("red"));
            textViewPlayer2.setTextColor(Color.parseColor("black"));
        }
        else
        {
            textViewPlayer2.setTextColor(Color.parseColor("red"));
            textViewPlayer1.setTextColor(Color.parseColor("black"));
        }
    }
